...
const Login: React.FC = () => {
  ...
  const handlePhoneLogin = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const { isNewUser } = await login(phoneNumber);
      
      if (isNewUser) {
        setShowNamePopup(true);
        toast.success('Welcome to PrintEasy! Please complete your profile.');
      } else {
                ...
                <TabsContent value="customer">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div className="space-y-1 text-sm text-neutral-700">
                      ...
                      <p className="text-xs text-neutral-500">Direct login - existing user with complete profile</p>
                      <p><strong>New Customer:</strong> 9876543299</p>
                      <p className="text-xs text-neutral-500">Auto-create new account with name popup</p>
                    </div>
                  </div>
                </TabsContent>
